(function(){
	...
	// Main app controller
	app.controller('appointmentListCtrl', ['$scope','$mdSidenav','$state','$rootScope','$localStorage','UserServices','AppointmentServices','$mdDialog', function ($scope, $mdSidenav, $state, $rootScope, $localStorage, UserServices, AppointmentServices, $mdDialog) {
        ...
        $scope.current = function(date){
          ...
          console.log(endDate)
          var query = '(doctor_id='+Id+',start_date='+startDate+',end_date='+endDate+',status=false,booked_status=true,appointment_status.status=scheduled,$or=type?patient_friendly_fees^type?hospital_fees^type?follow_up_fees)';
          console.log(query)
