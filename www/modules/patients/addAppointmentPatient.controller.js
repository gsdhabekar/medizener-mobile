(function(){
	...
	// Main app controller
	app.controller('addAppointmentPatientCtrl', ['$scope','$mdSidenav','$state','$rootScope','UserServices','$localStorage','AuthService','$mdDialog','formlyConfig','$cordovaDatePicker', function ($scope, $mdSidenav, $state, $rootScope, UserServices, $localStorage, AuthService, $mdDialog, formlyConfig, $cordovaDatePicker) {
